...
R is a powerful platform for data analysis, and it continues to improve.  It is easier than ever to get started in R, and, once you get comfortable, the quality and breadth of analyses you can create is astounding (e.g. this website was built using the [blogdown](https://github.com/rstudio/blogdown) R package).  R is not just statistical software; it is an end to end data science platform with interfaces to other state of the art software like [Spark](http://spark.apache.org/) and [Tensorflow](https://www.tensorflow.org/).
...
We are just getting started, but would love you contributions and feedback.  Please check us out on [GitHub](https://github.com/Ractuary) and let us know what you are up to: andy.merlino@tychobra.com
