...
The RActuary mission is to improve actuarial analysis.  Our guiding principles are to make analyses more:
 ...
 - **communicable**: We focus on presenting analyses via the web
 - **reproducible**: As in the final report can be regenerated from the code originally used to produce the analysis
...
There is a better way.  We just need to build out the tools and spread the knowledge.  For our own sanity and the sake of actuaries everywhere we need to move on from Excel.  RActuary is here to facilitate this transition.  If this interests you, please consider contributing to some of our packages.  We need all the help we can get.  If you aren't yet ready to contribute, but are still interested in RActuary, I would love to hear from you.  My email is [andy.merlino@tychobra.com](mailto:andy.merlino@tychobra.com).
...
htmlwidgets::saveWidget(g, file = "./blog/img/cran-pkgs.html", selfcontained = TRUE)
```
